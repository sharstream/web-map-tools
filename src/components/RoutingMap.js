...
export default class RoutingMap extends React.Component {
    ...
    setTooltip(features) {
        if (features.length) {
            ReactDOM.render(
                React.createElement(Tooltip, { features }),
                this.tooltipContainer
            );
        } else {
    ...
    handleChange(evt) {
        ...
        const profiles = document.querySelectorAll('input[type="radio"]');
        ...
        this.map.setPaintProperty("road-network", "line-color", [
            ...
            [
                ...
                [
                    "coalesce",
                    ["get", "maxspeed" + evt + ":forward"],
                    ["get", "maxspeed" + evt + ":backward"]
                ]
            ],
            0,
            "red",
    ...
    componentDidMount() {
                ...
                "line-color": [
                    ...
                    [
                        ...
                        [
                            ...
                            [
                                "coalesce",
                                ["get", "maxspeed0:forward"],
                                ["get", "maxspeed0:backward"]
                            ]
                        ],
                        0,
                        "red",
        ...
        this.map.on("load", () => {
            ...
            this.map.addLayer(layer, layel_id);
        });
                ...
                <div className="roadInfo">
                    <div className="information">
                        ...
                        <div className="info">
                            ...
                            {/* <TrafficPanel traffic={this.mapRef.current}/> */}
                        </div>
                    </div>
